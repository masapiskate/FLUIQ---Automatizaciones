from Config import GlobalsComerciales as g
...
def write_excel_with_format(output_file, selected_columns):
    with pd.ExcelWriter(output_file, engine="xlsxwriter") as writer:
        ...
        # Escribir la segunda fila ("Total a facturar")
        ...
        worksheet_totales.write_formula(3, 3, g.TOTAL_FORMULA, money_format)
...
"""
Función principal que maneja el proceso de partición de un archivo Excel, para el caso de "Canales".
"""
